...
<link rel="stylesheet" href="../css/log&join/join.css">
...
<body>
  ...
  <!-- 메인 -->
  <form action="join2" method="post" name="userInfo" onsubmit="return checkValue()">
    <h2>회원가입</h2>
        ...
        <table border="1" summary>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" id="member_id" name="member_id" fw-label="아이디" fw-msg fw-filter="isFill&isFill&isMin[4]&isMax[16]&isIdentity" class="inputTypeText">
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="member_pw" name="member_pw" fw-filter="isFill&isMin[[4]&isMax[16]" fw-label="비밀번호" fw-msg autocomplete="off" maxlength="16">
                        <span class="idMsg">(영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 8자~16자)</span>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <input type="password" id="member_pw_check" name="member_pw_check" fw-filter="isFill&isMatch[passwd]" fw-label="비밀번호 확인" 
                ...
                <tr>
                    ...
                    <td class="displaynone">
                        <select id="member_pw_question" name="member_pw_question">
                ...
                <tr>
                    ...
                    <td class="displaynone">
                        <input type="text" id="member_pw_answer" name="member_pw_answer" class="inputTypeText">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <span id="nameContents">
                            <input type="text" name="member_name" id="meber_name" maxlength="20">
                        </span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="member_email1" name="member_mail1">
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div id="jointxt">
        <div class="jointxt">
            이용약관 동의 (필수)<br>
            <textarea name="jointxt" class="jointxt">제1조(목적)

이 약관은 주식회사 커피콩(전자상거래 사업자)가 운영하는 커피콩(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리의무 및 책임사항을 규정함을 목적으로 합니다.

※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①“몰” 이란 주식회사 커피콩이 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호 모사전송번호 전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 커피콩 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
③ “몰”이 상품이나 용역에 대하여 「표시 광고의공정화에관한법률」 제3조 소정의 부당한 표시광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다.
...
부 칙(시행일) 이 약관은 2011년 7월 22일부터 시행합니다.
            ...
            <p><input type="checkbox"> 위 약관에 동의합니다<br></p>
        </div>
        <div class="jointxt">
            개인정보 수집 및 이용 동의 (필수)<br>
            <textarea name="jointxt" class="jointxt">■ 수집하는 개인정보 항목

회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 비밀번호 질문과 답변 , 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일 , 이메일 수신여부 , SMS 수신여부 , 서비스 이용기록 , 접속 로그 , 접속 IP 정보 , 결제기록
...
ο 회원 관리
회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 연령확인 , 만14세 미만 아동 가입 불가 , 고지사항 전달 ο 마케팅 및 광고에 활용
...
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.
            ...
            <p><input type="checkbox"> 위 개인정보의 수집 및 이용목적에 동의합니다. <br></p>
        </div>
    </div>
    <div id="joinbtn">
       <input class="joinbtn" type="submit" id="submit" name="submit" value="회원가입" />
    </div> 
  </form>  
