            ...
            <div class="review">
                      ...
                      <div class="review_table">
                          <table>
                            ...
                            <tr>
                              <td>제목</td>
                              <td colspan="3"><input type="text"class="review_index " value="난나나나난" name="" id=""></td>
                            </tr>

                            <tr>
                              <td>내용</td>
                              <td colspan="3"><textarea class="revarea content review_index" name="one2one_content" id="one2one_content">여기로 값을 가져옵니다</textarea></td>
                            </tr>
                          </table>
                          <br><br>
                        </div>
                  ...
                  <div class="btn">
                    ...
                    <span><input onclick="location.href='/mypage/product_review'" type="button" id="cancel" class="submit_button" name="" value="목록보기"></span>
                  </div>
                </div>
                <div id="sidebar"></div>
        <div id="footer"></div>
